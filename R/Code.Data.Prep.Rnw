...
#reduce data set and change columns
data_test <- data[,c(34, 3:6, 8, 9, 33, 35:38, 11:32)]
...
modelCd=bms(countryDat[,1:12], burn=1000, iter=5000, mcmc="bd",user.int=F)
modelTd=bms(timeDat[,1:7],user.int=F)
